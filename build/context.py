...
FAQ_GROUPS = [
  ...
  ("Comment se passent les séances", [
    ...
    ("Quelle est la fréquence idéale des séances ?",
     "Au début de l’accompagnement, je recommande généralement une séance par semaine. Le rythme s’adapte ensuite à l’évolution et aux disponibilités de chacun."),
    ...
    ("Combien de séances faut-il prévoir en tout ?",
     "Le besoin varie selon la nature des difficultés, l’âge, la motivation et l’assiduité de la personne. L’accompagnement s’inscrit dans la durée, avec un suivi adapté à chaque situation."),
  ]),
  ("Tarifs, remboursement et matériel", [
    ("Y a-t-il une prise en charge de la <abbr title='Caisse Primaire d’Assurance Maladie'>CPAM</abbr> ou des mutuelles ?",
     "Aucune prise en charge par l’Assurance Maladie n’est prévue à ce jour. Certaines mutuelles proposent une participation sur présentation de facture — renseignez-vous auprès de la vôtre. Des dispositifs d’aide peuvent exister selon votre situation : n’hésitez pas à m’en parler lors de notre premier échange."),
